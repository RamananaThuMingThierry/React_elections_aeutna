...
const EditElecteurNonAdhere = (props) =>{
    ...
    const SubmitUpdateElecteursNonAdhere = (e) =>{
        ...
        electeursInput.prenom = electeursInput.prenom ?? '';
        ...
        electeursInput.secteurs = electeursInput.secteurs ?? '';
        ...
        if(electeursInput.nom == ''){
            ...
            axios.post(`api/update-electeur-non-adhere/${id_membre}`, formData).then(res =>{ 
        ...
        <div className="row">
            <div className="col-md-12">
                <div className="card elevation-1 border-0 rounded-0 mt-2">
                    <h3 className="text-center text-muted roboto-font my-3">Modifier un nouveau bachelier</h3>
                </div>
            </div>
        </div>
        <div className="row">
            <div className="col-md-12">
                <div className="card elevation-1 border-0 rounded-0 mt-1">
                    <div className="card-body">
                        <form  onSubmit={SubmitUpdateElecteursNonAdhere}>
                              {/* Nom, Prénom, Sexe */}
                              <div className="row">
                                <div className="col-md-4">
                                    <label style={{fontWeight: 'bold', fontSize: '17px'}}  className="roboto-font" for="nom">Nom</label>
                                    <input className="form-control roboto-font p-3 rounded-0" type="text" autoComplete="false" id="nom" name="nom" value={electeursInput.nom ?? ''} placeholder="Saisir votre nom" onChange={handleInput}/>
                                </div>
                                <div className="col-md-4">
                                    <label style={{fontWeight: 'bold', fontSize: '17px'}} className="roboto-font"  for="prenom">Prénom</label>
                                    <input className="form-control roboto-font p-3 rounded-0" type="text" value={electeursInput.prenom ?? ''} id="prenom" name="prenom" autoComplete="false" placeholder="Saisir votre prénom" onChange={handleInput}/>
                                </div>
                                <div className="col-md-4">
                                    <label style={{fontWeight: 'bold', fontSize: '17px'}} className="roboto-font"  for="sexe">Sexe</label>
                                    <select className="form-select roboto-font rounded-0 p-3" name="sexe" id="sexe" value={electeursInput.sexe} onChange={handleInput}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4 mt-2">
                                    <label style={{fontWeight: 'bold', fontSize: '17px'}} className="roboto-font" for="delivrance_cin">Lieu de délivrance</label>
                                    <input className="form-control roboto-font p-3 rounded-0" type="text" value={electeursInput.delivrance_cin ?? ''} id="delivrance_cin" name="delivrance_cin" autoComplete="false" onChange={handleInput} placeholder="Saisir le lieu de délivrance de votre C.I.N"/>
                                </div>
                                <div className="col-md-4 mt-2">
                            ...
                            <div className="row">
                                <div className="col-md-4 mt-2">
                                    ...
                                    <input className="form-control roboto-font p-3 rounded-0" value={electeursInput.adresse ?? ''} type="text" id="adresse" name="adresse" autoComplete="false" onChange={handleInput} placeholder="Saisir votre adresse"/>
                                </div>
                                <div className="col-md-4 mt-2">
                                    <label style={{fontWeight: 'bold', fontSize: '17px'}} className="roboto-font" for="contact">Contact</label>
                                    <input className="form-control roboto-font p-3 rounded-0" value={electeursInput.contact ?? ''} type="number" maxLength={10} id="contact" name="contact" autoComplete="false" onChange={handleInput} placeholder="Saisir votre contact"/>
                                </div>
                                <div className="col-md-4 mt-2">
                                    <label style={{fontWeight: 'bold', fontSize: '17px'}} className="roboto-font" for="facebook">Facebook</label>
                                    <input className="form-control roboto-font p-3 rounded-0" value={electeursInput.facebook ?? ''} id="facebook" name="facebook" onChange={handleInput} type="text" placeholder="Saisir votre nom sur facebook" autoComplete="false"/>
                                </div>
                            </div> 
                            ...
                            <div className="col-md-4 offset-md-4 mt-4">
                                ...
                                <div className="col-md-4 mt-4">
                                    <button type="submit" className="btn btn-info p-3 roboto-font rounded-0 w-100">Modifier</button>
                                </div>
                            </div> 
                        </form>
                    </div>
...
export default EditElecteurNonAdhere;